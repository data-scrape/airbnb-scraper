...
**Airbnb Scraper** — Scrape Airbnb listings, prices, reviews, and host data

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/airbnb-scraper?style=social)
...
>
> **Search intent:** collect public Airbnb data for local market research, reputation analysis, and listing enrichment. Related topics: travel scraper, airbnb data, web scraping, python, data extraction.

## What this project is for

`airbnb-scraper` is an implementation-focused Python project for collecting public Airbnb data. It is designed around one practical job: turn a query such as **"coffee shops in Austin"** into structured records you can inspect, export, and pass into an automation workflow.
...
```bash
git clone https://github.com/data-scrape/airbnb-scraper.git
cd airbnb-scraper
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "Airbnb", "category": "Travel Scrapers"}
  }
}
```
